...
let s:rainbow_conf = {
\       'guifgs': ['red', 'green', 'blue', 'yellow'],
\       'ctermfgs': ['red', 'green', 'blue', 'yellow'],
\	'operators': '_,_',
...
\		'css': 0,
\               'sh': {
\                       'parentheses': [['\(^\|\s\)if\($\|\s\)','_\(^\|\s\)\(then\|else\|elif\)\($\|\s\)_','\(^\|\s\)fi\($\|\s\)'],
\                                       ['\(^\|\s\)while\($\|\s\)','_\(^\|\s\)\(do\)\($\|\s\)_','\(^\|\s\)done\($\|\s\)'],
\                                       ['\(^\|\s\)for\($\|\s\)','_\(^\|\s\)\(do\|in\)\($\|\s\)_','\(^\|\s\)done\($\|\s\)'],
\                                       ['\(^\|\s\)\S*()\s*{\?\($\|\s\)','_^{_','}'],
\                                       ['\(^\|\s\)case\($\|\s\)','_\(^\|\s\)\(\S*)\|in\|;;\)\($\|\s\)_','\(^\|\s\)esac\($\|\s\)']],
\               },
\	}
\}
